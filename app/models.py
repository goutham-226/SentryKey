...
class ApiKeys(Base):
    ...
    daily_context_quota: Mapped[int] = mapped_column(BigInteger,server_default="100000")
...
class UsageRecords(Base):
    ...
    context_tokens: Mapped[int] = mapped_column(BigInteger,server_default='0')
...
class Models(Base):
    ...
    history_budget_tokens: Mapped[int] = mapped_column(Integer,server_default='0')
    supports_temperature: Mapped[bool] = mapped_column(Boolean,server_default='false')
    max_token_schema: Mapped[str] = mapped_column(Text)
